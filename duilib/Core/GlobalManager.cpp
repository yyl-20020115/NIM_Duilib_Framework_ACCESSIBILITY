...
bool GlobalManager::m_bAccessibleEnabled = false;
...
void GlobalManager::EnableAccessbile(bool bEnabled)
{
	m_bAccessibleEnabled = bEnabled;
}
...
bool GlobalManager::IsAccessibleEnabled()
{
	return IsAccessibleEnabled;
}
