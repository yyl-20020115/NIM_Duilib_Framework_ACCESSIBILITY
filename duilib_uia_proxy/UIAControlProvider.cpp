...
namespace ui_automation
{
	...
	void UIAControlProvider::ResetControl(IAccessible* pControl)
	{
		m_pControl = pControl;
	}

	IAccessible* UIAControlProvider::GetControl() const
	{
		return m_pControl;
	}

	UIAWindowProvider* UIAControlProvider::GetWindow()
	{
		return this->m_pWindow;
	}

	HWND UIAControlProvider::GetHwnd()
	{
		return this->m_pWindow->GetHwnd();
	}
	...
	IFACEMETHODIMP UIAControlProvider::SetValue(LPCWSTR val) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_Value(BSTR* retVal) { *retVal = nullptr; UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_IsReadOnly(BOOL* retVal) { *retVal = false; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	// IInvokeProvider methods

	IFACEMETHODIMP UIAControlProvider::Invoke(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	// IRangeValueProvider methods

	IFACEMETHODIMP UIAControlProvider::SetValue(double val) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_Value(double* pRetVal) { *pRetVal = 0.0f; UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_Maximum(double* pRetVal) { *pRetVal = 0.0f;  UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_Minimum(double* pRetVal) { *pRetVal = 0.0f;  UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_LargeChange(double* pRetVal) { *pRetVal = 0.0f;  UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_SmallChange(double* pRetVal) { *pRetVal = 0.0f;  UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::Toggle(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_ToggleState(ToggleState* pRetVal) {
	...
	IFACEMETHODIMP UIAControlProvider::SetScrollPercent(double horizontalPercent, double verticalPercent) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_HorizontalScrollPercent(double* pRetVal) { *pRetVal = 0.0f; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_VerticalScrollPercent(double* pRetVal) { *pRetVal = 0.0f; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_HorizontalViewSize(double* pRetVal) { *pRetVal = 0.0f; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_VerticalViewSize(double* pRetVal) { *pRetVal = 0.0f; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_HorizontallyScrollable(BOOL* pRetVal) { *pRetVal = FALSE; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_VerticallyScrollable(BOOL* pRetVal) { *pRetVal = FALSE; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::GetSelection(SAFEARRAY** pRetVal) { *pRetVal = nullptr; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_CanSelectMultiple(BOOL* pRetVal) { *pRetVal = FALSE; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_IsSelectionRequired(BOOL* pRetVal) { *pRetVal = FALSE; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::Select(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }
	IFACEMETHODIMP UIAControlProvider::AddToSelection(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }
	IFACEMETHODIMP UIAControlProvider::RemoveFromSelection(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }


	IFACEMETHODIMP UIAControlProvider::get_IsSelected(BOOL* pRetVal) { *pRetVal = FALSE; UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_SelectionContainer(IRawElementProviderSimple** pRetVal) {
	...
	IFACEMETHODIMP UIAControlProvider::Expand(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::Collapse(void) { UIA_CHECK_ELEMENT_RETURN(m_pControl); }

	IFACEMETHODIMP UIAControlProvider::get_ExpandCollapseState(ExpandCollapseState* pRetVal) {
